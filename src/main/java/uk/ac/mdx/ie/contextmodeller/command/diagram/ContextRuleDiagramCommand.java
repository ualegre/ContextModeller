...
public class ContextRuleDiagramCommand extends DefaultBoxTool {
	...
	public void actionPerformed(IDiagramHandle representation,
		...
		try {
			...
			Element rule = CMFactory.createAndAddRule((Package) element);
			List<?> graph = representation.unmask(rule, rect.x, rect.y);
